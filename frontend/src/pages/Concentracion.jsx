...
const ConcentrationApp = () => {
  ...
  const fetchSessions = async () => {
    try {
      ...
      const data = await response.json();
      // Normalizar la respuesta: la API puede devolver un objeto o null;
      // aseguramos que `sessions` siempre sea un array.
    ...
    <div className="concentration-app">
      <div className="container">
        ...
        <div className="header">
          <h1 className="header-title">Entrenamiento de Concentración</h1>
