...
export default function Footer() {
  return (
    <footer className="site-footer bg-[#111827] text-white py-16">
    ...
    <FaInstagram />
          ...
          <div className="footer-links">
            ...
            <ul>
              ...
              <li>
                <Link to="/sesion-grupal" className="text-gray-400 hover:text-white hover:translate-x-1 transition">Sesión Grupal</Link>
              </li>
              <li>
                <Link 
                  to="/pomodoro" 
              ...
              <li>
                <Link to="/perfil" className="text-gray-400 hover:text-white hover:translate-x-1 transition">Perfil</Link>
              </li>
            </ul>
          </div>
